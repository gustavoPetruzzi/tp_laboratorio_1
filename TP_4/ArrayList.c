...
int al_clear(ArrayList* pList)
{
    ...
    if(pList != NULL)
    {
        returnAux = 0;
        pList->size = 0;
        auxPElement = realloc((pList->pElements), sizeof(void*)* AL_INITIAL_VALUE);
        if(auxPElement != NULL)
        {
            pList->reservedSize = AL_INITIAL_VALUE;
        }
...
int al_containsAll(ArrayList* pList,ArrayList* pList2)
{
    ...
    if(pList != NULL && pList2 != NULL)
    {
        ...
        {
            auxInt = al_contains(pList, (*((pList2->pElements)+ i)));
            if(auxInt != 1)
            {
                returnAux = 0;
                break;
...
int resizeUp(ArrayList* pList)
{
    ...
    if(pList != NULL)
    {
        ...
        {
            auxPElement = realloc((pList->pElements), sizeof(void*)* (pList->reservedSize + AL_INCREMENT));
            if(auxPElement != NULL)
            {
